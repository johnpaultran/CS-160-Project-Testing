...
public class MakeDifferentReservation {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // fill out reservation 2
        driver.findElement(By.xpath("//input[@name='firstName']")).sendKeys("Jack");
        driver.findElement(By.xpath("//input[@name='lastName']")).sendKeys("Frost");
        driver.findElement(By.xpath("//input[@name='email']")).sendKeys("cs160blackbox@gmail.com");
        driver.findElement(By.xpath("//input[@name='license']")).sendKeys("FR0STY1");
        driver.findElement(By.xpath("//button[@value='J']")).click();
        Thread.sleep(1000);

        // submit reservation 2 and quit
        driver.findElement(By.xpath("//*[@id=\"root\"]/form/div/button")).click();
        Thread.sleep(3000);
        //driver.quit();
    }
