...
public class MakeSameReservation {
    public static void main(String[] args) throws InterruptedException {
        ...
        // fill out reservation form 1
        driver.findElement(By.xpath("//*[@id=\"root\"]/form/div/div[2]/div[1]/input")).sendKeys("69CAT69");
        driver.findElement(By.xpath("//button[@value='B']")).click();
        Thread.sleep(1000);

        // submit reservation 1
        driver.findElement(By.xpath("//*[@id=\"root\"]/form/div/div[4]/button")).click();
        Thread.sleep(3000);

        // view reservations to ensure reservation created and go back to make same reservation
        driver.findElement(By.xpath("//a[@href='/reservations']")).click();
        Thread.sleep(3000);
        driver.findElement(By.xpath("//*[@id=\"root\"]/div[1]/a/button")).click();
        Thread.sleep(2000);

        // fill out reservation form 2
        driver.findElement(By.xpath("//*[@id=\"root\"]/form/div/div[2]/div[1]/input")).sendKeys("69CAT69");
        driver.findElement(By.xpath("//button[@value='B']")).click();
        Thread.sleep(1000);

        // try to submit reservation 2 and quit
        driver.findElement(By.xpath("//*[@id=\"root\"]/form/div/div[4]/button")).click();
        Thread.sleep(3000);
        driver.quit();
    }
